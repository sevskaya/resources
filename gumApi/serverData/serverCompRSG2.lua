    ...
    function apiSrv.getInformation(source, cb)
        ...
        if User then
            ...
            player.getGold = function()
                if User.Functions.GetItemByName("gold") == nil then
                    return 0
                else
                    local amountitem = User.Functions.GetItemByName("gold").amount
                    return amountitem
                end
            end
            ...
            player.removeGold = function(amount)
                User.Functions.RemoveItem("gold", amount)
            end
            ...
            player.openStorage = function(id, size)
                ...
                local data = { label = inventoryName, maxweight = size*1000, slots = 500 }
