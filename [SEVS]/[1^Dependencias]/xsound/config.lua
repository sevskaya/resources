...
-- Message list
config.Messages = {
    ["streamer_on"]  = "O modo Streamer está ativado. A partir de agora você não ouvirá nenhuma música/som.",
    ["streamer_off"] = "O modo Streamer está desativado. A partir de agora você poderá ouvir músicas que os jogadores possam tocar.",
